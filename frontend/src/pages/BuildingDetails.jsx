...
import { MapPin, FileText, Activity, Layers, Repeat, Eye, HardHat } from 'lucide-react';
import PageWrapper from '../components/layout/PageWrapper';
import { getScoreClass, formatGallons, formatSqft, formatRainfall, getScoreColor } from '../utils/formatters';
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-gray-800/60">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
             ...
             {building.final_viability_score >= 70 && (
          ...
          <p className="text-zinc-500 text-lg flex items-center gap-2">
            ...
            <span className="text-zinc-600 text-xs font-mono ml-2 block sm:inline">[{building.latitude.toFixed(4)}, {building.longitude.toFixed(4)}]</span>
          </p>
        </div>
        ...
        <div className="flex-shrink-0 flex items-center gap-6 bg-zinc-900 border border-white/5 p-4 rounded">
          ...
          <div className="text-right">
            ...
            <div className={`text-5xl font-display font-medium text-zinc-100 flex items-center justify-end`}>
              <CountUp to={building.final_viability_score} duration={2} />
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="p-6 rounded bg-zinc-900 border border-white/5 text-sm">
             ...
             <ul className="space-y-3">
                {building.cooling_tower_score > 0.6 && (
           ...
           <div>
             ...
             <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
               {FEATURE_GROUPS.map(group => {
                 ...
                 const scores = group.features.filter(f => f.format === 'score').map(f => building[f.key] || 0);
